...
// In the renderNysaFeedCards function, update the info-item section to use different terms:
        ...
        <div class="feed-detail-basic-info">
          <div class="feed-provider-section">
            ...
            <div class="feed-provider-meta">
              <div class="feed-provider-name">${feed.details.provider}</div>
              <div class="feed-city-item">
                <span><i class="far fa-clock"></i> ${feed.date.datePosted}</span>
                ${feed.city.location ? `<span><i class="fas fa-map-marker-alt"></i> ${feed.city.location}</span>` : ''}
              </div>
            </div>
          </div>
